...
//
//     final coutries = coutriesFromJson(jsonString);

import 'dart:convert';

List<Coutries> coutriesFromJson(String str) => List<Coutries>.from(json.decode(str).map((x) => Coutries.fromJson(x)));

String coutriesToJson(List<Coutries> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
